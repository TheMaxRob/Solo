...
final class MessageManager {
    ...
    func fetchConversation(conversationId: String) async throws -> Conversation {
        guard !conversationId.isEmpty else {
            throw MessageManagerError.invalidConversationId
        }
        ...
        do {
            ...
            if snapshot.exists {
                ...
                throw MessageManagerError.conversationNotFound
            }
            return Conversation(userIds: [], lastMessage: "", createdDate: Date())
        } catch {
            print("Error fetching conversation \(conversationId): \(error)")
            throw error
        }
    }
    ...
    func fetchConversationMessagesView(conversationId: String) async throws -> Conversation {
        ...
        do {
            ...
            print("Error in fetchConversationMessagesView: \(error)")
            throw error
        }
    }
    ...
    private func conversationExistsId(for userIds: [String]) async throws -> String? {
    ...
    func sendMessage(conversationId: String, message: Message, recipientId: String, senderId: String) async throws {
        ...
        do {
            ...
            if userSnapshot.exists {
                ...
                print("user \(userSnapshot.documentID) not found.")
    ...
    func fetchMessages(conversationId: String) async throws -> [Message] {
        guard !conversationId.isEmpty else {
            print("fetchMessages – conversationId is empty.")
            throw MessageManagerError.invalidConversationId
        }
    ...
    func setMessagesRead(conversationId: String) async throws {
        ...
        do {
            ...
            print("Error setting messages to read: \(error)")
            throw error
        }
    }
    ...
    func deleteMessage(messageId: String) async throws {
        guard !messageId.isEmpty else {
            throw MessageManagerError.invalidMessageId
        }
        do {
